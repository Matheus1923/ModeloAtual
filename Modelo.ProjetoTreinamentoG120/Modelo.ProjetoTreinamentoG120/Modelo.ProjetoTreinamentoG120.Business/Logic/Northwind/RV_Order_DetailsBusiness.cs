...
namespace Modelo.ProjetoTreinamentoG120.Business.Logic.Northwind
{
    ...
    /// <summary>
    /// RV_Order_DetailsBusiness class Business
    /// </summary>
    [RegraAtiva(true)]
    public class RV_Order_DetailsBusiness : GenericRuleEF<NorthwindEntities , Order_Details>
    {
    
    	public RV_Order_DetailsBusiness(NorthwindEntities contexto, Order_Details instancia)
