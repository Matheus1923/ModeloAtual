...
namespace Modelo.ProjetoTreinamentoG120.Business.Logic.Northwind
{
    ...
    /// <summary>
    /// RV_CustomersBusiness class Business
    /// </summary>
    [RegraAtiva(true)]
    public class RV_CustomersBusiness : GenericRuleEF<NorthwindEntities , Customers>
    {
    
    	public RV_CustomersBusiness(NorthwindEntities contexto, Customers instancia)
