...
namespace Modelo.ProjetoTreinamentoG120.Business.Logic.Northwind
{
    ...
    /// <summary>
    /// RV_RegionBusiness class Business
    /// </summary>
    [RegraAtiva(true)]
    public class RV_RegionBusiness : GenericRuleEF<NorthwindEntities , Region>
    {
    
    	public RV_RegionBusiness(NorthwindEntities contexto, Region instancia)
