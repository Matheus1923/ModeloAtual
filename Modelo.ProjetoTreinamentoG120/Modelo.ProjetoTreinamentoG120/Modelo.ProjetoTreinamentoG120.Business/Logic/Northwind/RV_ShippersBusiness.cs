...
namespace Modelo.ProjetoTreinamentoG120.Business.Logic.Northwind
{
    ...
    /// <summary>
    /// RV_ShippersBusiness class Business
    /// </summary>
    [RegraAtiva(true)]
    public class RV_ShippersBusiness : GenericRuleEF<NorthwindEntities , Shippers>
    {
    
    	public RV_ShippersBusiness(NorthwindEntities contexto, Shippers instancia)
