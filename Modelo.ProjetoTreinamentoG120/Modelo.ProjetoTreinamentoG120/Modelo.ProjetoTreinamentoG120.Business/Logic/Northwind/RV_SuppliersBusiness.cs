...
namespace Modelo.ProjetoTreinamentoG120.Business.Logic.Northwind
{
    ...
    /// <summary>
    /// RV_SuppliersBusiness class Business
    /// </summary>
    [RegraAtiva(true)]
    public class RV_SuppliersBusiness : GenericRuleEF<NorthwindEntities , Suppliers>
    {
    
    	public RV_SuppliersBusiness(NorthwindEntities contexto, Suppliers instancia)
