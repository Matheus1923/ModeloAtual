...
namespace Modelo.ProjetoTreinamentoG120.Business.Logic.Northwind
{
    ...
    /// <summary>
    /// RV_CategoriesBusiness class Business
    /// </summary>
    [RegraAtiva(true)]
    public class RV_CategoriesBusiness : GenericRuleEF<NorthwindEntities , Categories>
    {
    
    	public RV_CategoriesBusiness(NorthwindEntities contexto, Categories instancia)
