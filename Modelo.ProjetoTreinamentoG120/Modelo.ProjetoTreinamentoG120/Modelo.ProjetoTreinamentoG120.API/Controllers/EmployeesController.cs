...
namespace Modelo.ProjetoTreinamentoG120.API.Controllers
{
    public class EmployeesController : ApiController
    {
        private NorthwindEntities db = new NorthwindEntities();

        private readonly EmployeesDataApplicator employeesDT;
        public EmployeesController()
        {

            employeesDT = new EmployeesDataApplicator(db);
        ...
        {
            var result = employeesDT.ObterTodos();
            return result;
            //return db.Employees;
        }
        ...
        {
            Employees employees = employeesDT.ObterPorId(id);
            if (employees == null)
            {
                return NotFound();
            }
